...
$$\begin{align*}\Delta(P(WM),P(W)P(M)) = \sum_m\frac{1}{2}\sum_w\frac{1}{2}|P(W=w|M=M_0)-P(W=w|M=M_1)|\end{aling*}$$=\frac{1}{2}\sum_w|P(W=w|M=M_0)-P(W=m|M=m_1)|=\frac{1}{2}\Delta(P(W|M_0)-P(W|M_1))\end{aling*}
