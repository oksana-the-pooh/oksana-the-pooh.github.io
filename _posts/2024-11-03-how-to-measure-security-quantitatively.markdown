...
Let's show that $$\text{Distinguish security }\leftrightarrow\text{ Semantic security}$$: $$\text{Adv}_{\text{Semantic}}\leq \text{Adv}_{\text{Distinguish}}\leq 2\text{Adv}_{\text{Semantic}}$$
